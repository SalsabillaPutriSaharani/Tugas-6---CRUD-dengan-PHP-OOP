      ...
      <div class="container">
        ...
        <form method="POST" action="proses.php" class="font-weight-bold">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="nim" class="form-control" id="Nim" placeholder="contoh: 20051214021" required value="<?php echo $nim; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="namamhs" class="form-control" id="Namamhs" placeholder="contoh: Salsabilla Putri Saharani" required value="<?php echo $namamhs; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text"  name="alamat" class="form-control" id="Alamat" placeholder="Contoh: Nomor 14 RT 04 RW 02, Desa Ngampel " required value="<?php echo $alamat; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="kota" class="form-control" id="Kota" placeholder="contoh: Gresik" required value="<?php echo $kota; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="email" name="email" class="form-control" id="Email" placeholder="contoh: salsabilla.12@mhs.unesa.ac.id" required value="<?php echo $email; ?>">
                </div>
            </div>
